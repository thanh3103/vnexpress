...
<div id="hero">
    <div id="owl-main" class="owl-carousel height-lg owl-inner-nav owl-ui-lg">
        ...
        <div class="item" style="background-image: url(resources/assets/images/sliders/head-logo.png);">
...
<!--                     </div> -->
        ...
        <div class="item" style="background-image: url(resources/assets/images/sliders/maxresdefault.jpg);">
            <div class="container-fluid">
...
<div class="container">
    <div class="title-nav">
        <h2 class="inverse">Recommended Pets</h2>
    ...
    <div id="owl-recommended-products" class="owl-carousel product-grid-holder">
        <div class="no-margin carousel-item product-item-holder hover size-medium">
            <div class="product-item">
                <div class="ribbon green"><span>best sellers</span></div> 
                <div class="image">
...
<!-- ============================================================= FOOTER : END ============================================================= -->   </div><!-- /.wrapper -->
    ...
    <script type="text/javascript" src="<c:url value="/resources/switchstylesheet/switchstylesheet.js" />"></script>

            ...
            <ul class="right">
                ...
                <c:choose>
                	<c:when test="${not empty pageContext.request.userPrincipal.name}">
                		<c:choose>
                			<c:when test="${pageContext.request.userPrincipal.name == 'admin1'}">
                				<li><a href="${pageContext.request.contextPath}/admin">Management</a></li>
                			</c:when>
                		</c:choose>
...
<%--     <form:form class="form-horizontal" action="${pageContext.request.contextPath}/product/search" method="post" --%>
<%-- 				 modelAttribute="categories" enctype="multipart/form-data"> --%>
				
<!--         <div class="control-group"> -->
<!--             <input class="search-field" placeholder="Search for item" id="searchForm" name="searchForm"/> -->
...
<%-- <%-- 								<option value="${category.id}" id="categoryID">${category.categoryName}</option> --%>
<%-- <%-- 								</c:forEach> --%>
<!-- <!-- 							</select> -->
							
<!-- <!--                 </li> -->
<!--             </ul> -->
<%-- <%--             <a class="search-button" href="${pageContext.request.contextPath}/product/search?categoryID=${category.id}" ></a>     --%>

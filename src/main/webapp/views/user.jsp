...
<div class="container-fluid">
	...
	<div class="col-sm-9">
		<h2>Account Dashboard</h2><hr />
		<div class="container-fluid jumbotron">
			<h3>Personal Information</h3><h4><a href="${pageContext.request.contextPath}/user/edit?username=${pageContext.request.userPrincipal.name}">Edit</a></h4><br /><br />
			...
			<h3>Phone Number: ${user.phoneNo}</h3><br />
		</div>
	</div>
</div>
</body>

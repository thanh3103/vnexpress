...
<link rel="stylesheet"
	href="<c:url value="/resources/assets/css/green.css" />">
<link rel="stylesheet"
	href="<c:url value="/resources/assets/css/owl.carousel.css" />">
<link rel="stylesheet"
	href="<c:url value="/resources/assets/css/owl.transitions.css" />">
<link rel="stylesheet"
	href="<c:url value="/resources/assets/css/animate.min.css" />">

<!-- Demo Purpose Only. Should be removed in production -->
<link rel="stylesheet"
	href='<c:url value="/resources/assets/css/config.css" />'>
<!-- <a href="/resources/assets/css/config.css"></a> -->
<link href='<c:url value="/resources/assets/css/green.css"/>'
	rel="alternate stylesheet" title="Green color">
<link href='<c:url value="/resources/assets/css/blue.css"/>'
	rel="alternate stylesheet" title="Blue color">
<link href='<c:url value="/resources/assets/css/red.css"/>'
	" rel="alternate stylesheet" title="Red color">
<link href='<c:url value="/resources/assets/css/orange.css"/>'
	rel="alternate stylesheet" title="Orange color">
<link href='<c:url value="/resources/assets/css/navy.css"/>'
	rel="alternate stylesheet" title="Navy color">
<link href='<c:url value="/resources/assets/css/dark-green.css"/>'
	...
	<div class="wrapper">
		...
		<div class="container">
			<div class="col-xs-12 col-sm-6 no-margin">
				<ul>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#change-colors">Change Colors</a>
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#pages">Pages</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="index.html">Home</a></li>
							<li><a href="index-2.html">Home Alt</a></li>
							<li><a href="category-grid.html">Category - Grid/List</a></li>
							<li><a href="category-grid-2.html">Category 2 -
									Grid/List</a></li>
							<li><a href="single-product.html">Single Product</a></li>
							<li><a href="single-product-sidebar.html">Single Product
									with Sidebar</a></li>
			...
			<div class="col-xs-12 col-sm-6 no-margin">
				<ul class="right">
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#change-language">English</a>
						<ul class="dropdown-menu" role="menu">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						data-toggle="dropdown" href="#change-currency">Dollar (US)</a>
						<ul class="dropdown-menu" role="menu">
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="#">Euro (EU)</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="#">Turkish Lira (TL)</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="#">Indian Rupee (INR)</a></li>
							<li role="presentation"><a role="menuitem" tabindex="-1"
								href="#">Dollar (US)</a></li>
						</ul></li>
		...
		<div class="container no-padding">
			...
			<div class="col-xs-12 col-md-3 logo-holder">
				<!-- ============================================================= LOGO ============================================================= -->
				<div class="logo">
					<a href="index.html"> <!--<img alt="logo" src="assets/images/logo.svg" width="233" height="54"/>-->
			...
			<div class="col-xs-12 col-md-3 top-cart-row no-margin">
				<div class="top-cart-row-container">
					<div class="wishlist-compare-holder">
						<div class="wishlist ">
							<a href="#"><i class="fa fa-heart"></i> wishlist <span
								class="value">(21)</span> </a>
						</div>
						<div class="compare">
							<a href="#"><i class="fa fa-exchange"></i> compare <span
						...
						<div class="basket">
							...
							<a class="dropdown-toggle" data-toggle="dropdown" href="#">
								<div class="basket-item-count">
									<span class="count">${countCart}</span> <img
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								<c:forEach items="${categories}" var="category">
									<li class="dropdown"
										onclick="location.href='${pageContext.request.contextPath}/product/pet?name=${category.categoryName}'">
										<a
										href="${pageContext.request.contextPath}/product/pet?name=${category.categoryName}"
										class="dropdown-toggle" data-hover="dropdown"
										data-toggle="dropdown">${category.categoryName}</a> <input
										type="hidden" value="${category.id}" />
									</li>
								</c:forEach>
		...
		<!-- /.container --> </nav><!-- /.megamenu-vertical --> <!-- ========================================= NAVIGATION : END ========================================= -->
		...
		<div id="single-product">
			<div class="container">
					  ...
					  <form:form class="form-horizontal" action="./save" method="post" modelAttribute="product" enctype="multipart/form-data">
					...
					<div class="no-margin col-xs-12 col-sm-6 col-md-5 gallery-holder">
						<div
							...
							<div class="single-product-gallery-thumbs gallery-thumbs">
								...
								<div id="owl-single-product-thumbnails"></div>
...
<%-- 							<div class="brand">${category.categoryName}</div> --%>
							...
							<div class="qnt-holder">
								...
								<div class="add-cart-button">
									<a
										href="${pageContext.request.contextPath}/product/add?id=${product.id}&name=${category.categoryName}"
	...
	<div class="container">
		<div class="carousel-holder hover">
			...
			<div id="owl-recently-viewed"
				class="owl-carousel product-grid-holder"></div>
			<!-- /#recently-carousel -->
		...
		<div class="row no-margin widgets-row">
			...
			<div class="copyright-bar">
				<div class="container">
					<div class="col-xs-12 col-sm-6 no-margin">
						<div class="copyright">
							&copy; <a href="index.html">Pet Center</a> - all rights reserved
						</div>
						<!-- /.copyright -->
					</div>
					<div class="col-xs-12 col-sm-6 no-margin">
						<div class="payment-methods ">
							<ul>
								<li><img alt=""
									src="assets/images/payments/payment-visa.png"></li>
								<li><img alt=""
	...
	<div class="config open">
		<div class="config-options">
			...
			<ul class="list-unstyled animate-dropdown">
				<li class="dropdown">
					<button class="dropdown-toggle btn le-button btn-block"

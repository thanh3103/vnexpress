            ...
            <div class="row no-margin cart-item">
                <div class="col-xs-12 col-sm-2 no-margin">
                    <a href="#" class="thumb-holder">
                        <img class="lazy" alt="" src="data:image/jpeg;base64,${orderDetail.product.base64ImageFile}">
                    </a>
                </div>

                <div class="col-xs-12 col-sm-5 ">
                    <div class="title">
                        <a href="#">${orderDetail.product.productName}</a>
                    </div>
                    <div class="brand">${orderDetail.product.description}</div>
<%--                     <div class="brand">Post By: ${orderDetail.product.user.userName}</div> --%>
                </div> 
...
<%--                             </form> --%>
								<input type="number" id="quantity_${orderDetail.product.id}"
									value="${orderDetail.quantity}" style="width: 50px" />
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-xs-12 col-sm-2 no-margin">
                    ...
                    <a class="close-btn" href="<c:url value="/product/remove" />?id=${orderDetail.product.id}"></a>
                </div>
            </div><!-- /.cart-item -->
		</c:forEach>
        </div>
                ...
                <div class="body">
                    <ul class="tabled-data no-border inverse-bold">
                        <li>
                            ...
                            <div class="value pull-right">$${order.totalPrice}</div>
                        </li>
                        <li>
                    ...
                    <div class="buttons-holder">
                        <a class="le-button big" href="${pageContext.request.contextPath}/order/addOrder" >checkout</a>

            ...
            <c:forEach items="${order.listOrderDetail}" var="orderDetail">
                <li>
                    <div class="basket-item">
                        ...
                        <a class="close-btn" href="<c:url value="/product/removeCart" />?id=${orderDetail.product.id}"></a> <!-- remove product -->
                    </div>
                </li>
             </c:forEach>
...
<div class="container-fluid">
	<div class="col-sm-3">
		...
		<h2><a href="${pageContext.request.contextPath}/user/">Account Dashboard</a></h2>
		<h2><a href="${pageContext.request.contextPath}/user/post">Post Pet Sales</a></h2>
		<h2><a href="${pageContext.request.contextPath}/user/edit?username=${pageContext.request.userPrincipal.name}">Personal Information</a></h2>
	</div>
	<div class="col-sm-9">
		<h2>Personal Information</h2><hr />
		<div class="container-fluid jumbotron">
			<form:form modelAttribute="user" class="form-horizontal" action="${pageContext.request.contextPath}/user/edit/save" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<div class="col-sm-offset-4 col-sm-6">
						...
						<button type="button" onclick="location.href='${pageContext.request.contextPath}/user/'"

...
<!-- <a href="/resources/assets/css/config.css"></a> -->
            ...
            <ul class="right">
                ...
                <c:choose>
                	<c:when test="${not empty pageContext.request.userPrincipal.name}">
                		<li><a href="${pageContext.request.contextPath}/user/">Welcome : ${pageContext.request.userPrincipal.name}</a></li>
...
<!-- ============================================================= SEARCH AREA : END ============================================================= -->      </div><!-- /.top-search-holder -->
    ...
    <div class="top-cart-holder dropdown animate-dropdown">
        ...
        <div class="basket">
            ...
            <a class="dropdown-toggle" data-toggle="dropdown" href="${pageContext.request.contextPath}/product/cart">
...
<!-- 					<span>2</span> -->
                ...
                <div class="total-price-basket"> 
                    ...
                    <span class="total-price">
                        <span class="sign">$</span><span class="value">${order.totalPrice}</span>
                    </span>
                </div>
            </a>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-4 col-sm-4 no-margin text-center">
                                <div class="thumb">
                                    <img alt="" src="data:image/jpeg;base64,${orderDetail.product.base64ImageFile}" />
                                </div>
                            </div>
                            <div class="col-xs-8 col-sm-8 no-margin">
                                <div class="title">${orderDetail.product.productName}</div>
                                <div class="price">$${orderDetail.product.price}</div>
                            </div>
                        </div>
                        <a class="close-btn" href="<c:url value="/product/removeCart" />?id=${orderDetail.product.id}&name=${category.categoryName}"></a> <!-- remove product -->
                    </div>
                </li>
             </c:forEach>
                    ...
                    <div class="basket-item">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                <a href="${pageContext.request.contextPath}/product/cart" class="le-button inverse">View cart</a>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <a href="${pageContext.request.contextPath}/order/addOrder" class="le-button" onclick="location.href='${pageContext.request.contextPath}/order/addOrder'">Checkout</a>
                            </div>
                        </div>
                    </div>
                </li>
        ...
        <div class="yamm navbar">
            ...
            <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                ...
                <c:forEach items="${categories}" var="category">
                    <li class="dropdown" onclick="location.href='${pageContext.request.contextPath}/product/pet?name=${category.categoryName}'">
                        <a href="${pageContext.request.contextPath}/product/pet?name=${category.categoryName}" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">${category.categoryName}</a>
...
<section id="category-grid">
    <div class="container">
        ...
        <!-- ========================================= SIDEBAR ========================================= -->
<!--         <div class="col-xs-12 col-sm-2 no-margin sidebar narrow"> -->
...
<!--         </div> -->
        ...
        <div class="col-xs-12 col-sm-10 no-margin wide sidebar">
...
<!--                                 <div class="ribbon red"><span>sale</span></div>  -->
                                <div class="image">
                                    <img alt="" src="data:image/jpeg;base64,${product.base64ImageFile}" width="150px" height="150px"/>
                                </div>
                                <div class="body">
<!--                                     <div class="label-discount green">-50% sale</div> -->
                                    ...
                                    <div class="brand">${product.description}</div>
                                    <div class="brand"><a href="#">Post By: ${product.user.userName}</a></div>
                                </div>
                                <div class="prices">
<!--                                     <div class="price-prev">$1399.00</div> -->
                                ...
                                <div class="hover-area">
                                    <div class="add-cart-button">
                                        <a href="${pageContext.request.contextPath}/product/add?id=${product.id}&name=${category.categoryName}" class="le-button">add to cart</a>
                                    </div>
                                    <a href="${pageContext.request.contextPath}/product/getProduct?id=${product.id}&mode='VIEW'&name=${category.categoryName}">
                                    <button class="btn btn-info" onclick="getProduct(${product.id},'VIEW',${category.categoryName});">
                                    	View
                                    </button></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 text-left">
                            ...
                            <c:forEach varStatus="loop" begin="0" end="${pages}">
                                <li class="current">
                                <a  href="${pageContext.request.contextPath}/product/pet?name=${category.categoryName}&page=${loop.count}">
                                <c:out value="${loop.count}"/></a></li>
                            </c:forEach>
                            </ul>
                        </div>
...
<!-- ============================================================= FOOTER : END ============================================================= -->	</div><!-- /.wrapper -->
	...
	<script type="text/javascript" src="<c:url value="/resources/assets/js/jquery-1.10.2.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/jquery-migrate-1.2.1.js" />"></script>
    ...
    <script type="text/javascript" src="<c:url value="/resources/assets/js/gmap3.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/bootstrap-hover-dropdown.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/owl.carousel.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/css_browser_selector.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/echo.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/jquery.easing-1.3.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/bootstrap-slider.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/jquery.raty.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/jquery.prettyPhoto.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/jquery.customSelect.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/wow.min.js" />"></script>
    <script type="text/javascript" src="<c:url value="/resources/assets/js/scripts.js" />"></script>
